...
var Subject = config.get ('german.names.subject');
...
var segment = [5221, 5225, 5229, 5233, 2125];

var campaignname = [];

campaignname[5221] = "Achadirect.com Newsletter Klaus OLD YES Sales German |" + ' ' + m + ' ' + y;
campaignname[5225] = "Achadirect.com Newsletter Klaus NEW YES Sales German |" + ' ' + m + ' ' + y;
campaignname[5229] = "Achadirect.com Newsletter Sunny OLD YES Sales German |" + ' ' + m + ' ' + y;
campaignname[5233] = "Achadirect.com Newsletter Sunny NEW YES Sales German |" + ' ' + m + ' ' + y;
campaignname[2125] = "Achadirect.com Newsletter NEW NO Sales German |" + ' ' + m + ' ' + y;


var google =[];

google[5221] = "Achadirect_com_Newsletter_Klaus_O_Y_DE_" + m.substring (0, 3) + "_" + y;
google[5225] = "Achadirect_com_Newsletter_Klaus_N_Y_DE_" + m.substring (0, 3) + "_" + y;
google[5229] = "Achadirect_com_Newsletter_Sunny_O_Y_DE_" + m.substring (0, 3) + "_" + y;
google[5233] = "Achadirect_com_Newsletter_Sunny_N_Y_DE_" + m.substring (0, 3) + "_" + y;
google[2125] = "Achadirect_com_Newsletter_N_N_DE_" + m.substring (0, 3) + "_" + y;
...
function parachange () {
	...
	} else {buffer.settings.from_name = "Acha Co.,Ltd.", buffer.settings.reply_to = "websales_de@achadirect.com"
	};

...
var Subject = config.get ('spanish.names.subject');
...
var segment = [5205, 5209, 5213, 5217, 2133];

var campaignname = [];

campaignname[5205] = "Achadirect.com Newsletter Klaus OLD YES Sales Spanish |" + ' ' + m + ' ' + y;
campaignname[5209] = "Achadirect.com Newsletter Klaus NEW YES Sales Spanish |" + ' ' + m + ' ' + y;
campaignname[5213] = "Achadirect.com Newsletter Namoon OLD YES Sales Spanish |" + ' ' + m + ' ' + y;
campaignname[5217] = "Achadirect.com Newsletter Namoon NEW YES Sales Spanish |" + ' ' + m + ' ' + y;
campaignname[2133] = "Achadirect.com Newsletter NEW NO Sales Spanish |" + ' ' + m + ' ' + y;


var google =[];

google[5205] = "Achadirect_com_Newsletter_Klaus_O_Y_ES_" + m.substring (0, 3) + "_" + y;
google[5209] = "Achadirect_com_Newsletter_Klaus_N_Y_ES_" + m.substring (0, 3) + "_" + y;
google[5213] = "Achadirect_com_Newsletter_Namoon_O_Y_ES_" + m.substring (0, 3) + "_" + y;
google[5217] = "Achadirect_com_Newsletter_Namoon_N_Y_ES_" + m.substring (0, 3) + "_" + y;
google[2133] = "Achadirect_com_Newsletter_N_N_ES_" + m.substring (0, 3) + "_" + y;
...
function parachange () {
	...
	} else {buffer.settings.from_name = "Acha Co.,Ltd.", buffer.settings.reply_to = "websales_es@achadirect.com"
	};
